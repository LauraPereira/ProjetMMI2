...
(2, 'L\'Australie', './media/videos/LaPavlova.mp4', './media/videos/HistoireAustralie.mp4', './media/videos/IntroAustralie.mp4', './media/images/Australie/OtarieAustralie.png', './media/images/Australie/Kangourou.png', './media/images/Australie/IconeAustralie.png', './media/images/Australie/PlancheSurf.png', './php/Pays.php?idLien=2', './php/JeuPays.php?idLien=2', './media/images/Australie/puzzleSyndey.png'),
(3, 'L\'Inde', './media/videos/PouletAuCurry.mp4', './media/videos/HistoireInde.mp4', './media/videos/IntroInde.mp4', './media/images/Inde/ImageOtarie.png', './media/images/Inde/Elephant.png', './media/images/Inde/IconeInde.png', './media/images/Inde/TajMahal.png', './php/Pays.php?idLien=3', './php/JeuPays.php?idLien=3', './media/images/Inde/TajMahal.png'),
(4, 'Le Mexique', './media/videos/Tacos.mp4', './media/videos/HistoireMexique.mp4', './media/videos/IntroMexique.mp4', './media/images/Mexique/OtarieMexique.png', './media/images/Mexique/Aigle.png', './media/images/Mexique/iconeMe.png', './media/images/Mexique/Temple.png', './php/Pays.php?idLien=4', './php/JeuPays.php?idLien=4', './media/images/Mexique/PuzzleMexique.png'),
(5, 'La Grèce', './media/videos/SaladeGrecque.mp4', './media/videos/HistoireGrece.mp4', './media/videos/IntroGrece.mp4', './media/images/Grece/OtarieGrece.png', './media/images/Grece/Chouette.png', './media/images/Grece/iconeGr.png', './media/images/Grece/Colonne.png', './php/Pays.php?idLien=5', './php/JeuPays.php?idLien=5', './media/images/Grece/PuzzleGrece.png');
