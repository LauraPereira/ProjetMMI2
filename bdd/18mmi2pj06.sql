...
(1, 'L\'Égypte', './media/videos/MenenathCuisineEgypte.mp4', './media/videos/DessinAnimeEgypte.mp4', './media/videos/IntroEgypte.mp4', './media/images/Egypte/OtarieEgypte.png', './media/images/Egypte/EgypteChameau.png', './media/images/Egypte/Pyramide.png', './media/images/Egypte/PyramideTrois.png', './php/Pays.php?idLien=1', './php/JeuPays.php?idLien=1', './media/images/Egypte/sphinx.png'),
(2, 'L\'Australie', './media/videos/LaPavlova.mp4', '', '', './media/images/Australie/OtarieAustralie.png', './media/images/Australie/Kangourou.png', './media/images/Australie/IconeAustralie.png', './media/images/Australie/PlancheSurf.png', './php/Pays.php?idLien=2', './php/JeuPays.php?idLien=2', './media/images/Australie/puzzleSyndey.png'),
(3, 'L\'Inde', '', '', '', './media/images/Inde/ImageOtarie.png', './media/images/Inde/Elephant.png', './media/images/Inde/IconeInde.png', NULL, './php/Pays.php?idLien=3', './php/JeuPays.php?idLien=3', './media/images/Inde/TajMahal.png'),
(4, 'Le Mexique', '', '', '', './media/images/Mexique/OtarieMexique.png', './media/images/Mexique/Aigle.png', './media/images/Mexique/iconeMe.png', NULL, './php/Pays.php?idLien=4', './php/JeuPays.php?idLien=4', './media/images/Mexique/PuzzleMexique.png'),
(5, 'La Grèce', '', '', '', './media/images/Grece/OtarieGrece.png', './media/images/Grece/Chouette.png', './media/images/Grece/iconeGr.png', NULL, './php/Pays.php?idLien=5', './php/JeuPays.php?idLien=5', './media/images/Grece/PuzzleGrece.png');
